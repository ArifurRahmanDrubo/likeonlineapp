...
return [
    ...
    /*
      ...
      */
    // Points at this app's dedicated settlement callback (routes/web.php).
    // A relative path is resolved to an absolute URL at request time by the
    // payment controller; override via NAGAD_CALLBACK_URL in .env if needed.
    "callback_url"    => env("NAGAD_CALLBACK_URL", "/portal/payments/nagad/callback"),
